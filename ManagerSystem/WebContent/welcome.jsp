...
<table width="100%" height="615" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" height="100%"><table width="635" height="236" border="0" cellpadding="0" cellspacing="0" class="textB">
        <tr align="center">
          <td height="282" colspan="2" background="img/login_top.jpg" >&nbsp;</td>
        </tr>
        <tr align="center">
          <td width="18" height="120" background="img/login_left.jpg" class="tableBorder_lb" >&nbsp;</td>
        ...
        <tr>
          ...
          <td width="97" align="center" ><input type="image" name="imageField" src="img/login_btn.jpg"></td>
